...
(function () {
  ...
  const SERVICES = {
    roofing: {
      ...
      image: "", hubImage: "", imageAlt: "A completed Cenvar shingle roof",
      questions: [
    ...
    windows: {
      ...
      // then paste the two asset URLs here.
      image: "", hubImage: "", imageAlt: "Black-framed windows on a modern home",
      questions: [
    ...
    doors: {
      ...
      // then paste the two asset URLs here.
      image: "", hubImage: "", imageAlt: "Black double entry doors on a covered porch",
    ...
    siding: {
      ...
      // then paste the two asset URLs here.
      image: "", hubImage: "", imageAlt: "Cedar shake siding on a gable end",
      questions: [
